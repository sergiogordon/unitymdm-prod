...
async def deploy_apk(
    ...
    structured_logger.log_event(
        ...
        success_count=len(installations),
        failed_count=len(failed_devices),
        total_devices=len(target_device_ids) # Assuming target_device_ids is defined elsewhere or should be len(devices)
    )
...
async def deploy_apk(
    ...
    structured_logger.log_event(
        ...
        success_count=len(installations),
        failed_count=len(failed_devices),
        total_devices=len(devices) # Corrected from target_device_ids
    )

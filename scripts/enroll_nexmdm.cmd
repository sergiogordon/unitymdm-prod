...
adb shell cmd deviceidle whitelist -com.unitynetwork.unityapp 1>nul 2>&1
adb shell cmd deviceidle whitelist +com.unitynetwork.unityapp 1>nul 2>&1
adb shell appops set com.unitynetwork.unityapp RUN_ANY_IN_BACKGROUND allow 2>nul
adb shell appops set com.unitynetwork.unityapp AUTO_REVOKE_PERMISSIONS_IF_UNUSED ignore 2>nul
